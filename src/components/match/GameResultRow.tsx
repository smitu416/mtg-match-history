  ...
  return (
    <div className="border border-slate-700 rounded-lg p-3 bg-slate-800/50">
      ...
      <div className="flex items-center gap-3 mb-2">
        {/* ゲーム番号ラベル（例: "G1"） */}
        <span className="font-bold text-slate-300 w-6 shrink-0">
          G{gameNumber}
        </span>
      ...
      <textarea
        ...
        rows={2}
        className="w-full text-sm bg-slate-900 text-slate-300 border border-slate-700 rounded p-2 resize-none
