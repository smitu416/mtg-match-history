    ...
    <div className="bg-slate-900 rounded-xl border border-slate-700 p-5 max-w-lg mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-semibold text-slate-300">ゲーム結果</label>
  ...
  return (
    <>
      <input
        ...
        className="w-full bg-slate-800 text-slate-200 border border-slate-600 rounded-lg px-3 py-2 text-sm
